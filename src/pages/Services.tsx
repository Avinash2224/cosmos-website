    ...
    <div className="pt-20">
      ...
      {/* <section className="py-24 px-6 lg:px-12 bg-earth-beige">
        <div className="max-w-5xl mx-auto">
          <FadeIn>
            <h2 className="font-serif text-4xl md:text-5xl text-earth-charcoal mb-12 text-center">
              Our Approach
            </h2>
          </FadeIn>
          ...
          <div className="space-y-16">
            <FadeIn delay={100}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <h3 className="font-serif text-3xl text-earth-charcoal mb-4">
                    Discovery
                  </h3>
                  <p className="text-earth-stone leading-relaxed">
                    We begin by deeply understanding your vision, values, and audience. This foundation ensures every creative decision is intentional and aligned.
                  </p>
                </div>
            ...
            <FadeIn delay={200}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div className="aspect-[4/3] overflow-hidden">
                  <img
                    src="https://images.pexels.com/photos/1654698/pexels-photo-1654698.jpeg?auto=compress&cs=tinysrgb&w=1200"
                ...
                <div>
                  ...
                  <p className="text-earth-stone leading-relaxed">
                    With meticulous attention to detail, we craft each frame, each moment. Our process blends technical mastery with artistic intuition.
                  </p>
                </div>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={300}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-earth-stone leading-relaxed">
                    Through thoughtful iteration and polish, we ensure the final work exceeds expectations and resonates with authenticity.
                  </p>
                </div>
                <div className="aspect-[4/3] overflow-hidden order-first md:order-last">
                  <img
                    src="https://images.pexels.com/photos/3184639/pexels-photo-3184639.jpeg?auto=compress&cs=tinysrgb&w=1200"
                    alt="Refinement process"
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
