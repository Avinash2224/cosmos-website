...
export default function Works() {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: 'commercial',
      type: 'Brand Film',
      image: 'https://images.pexels.com/photos/2873486/pexels-photo-2873486.jpeg?auto=compress&cs=tinysrgb&w=1200',
    ...
    },
    {
      ...
      category: 'film',
      type: 'Short Film',
      image: 'https://images.pexels.com/photos/1089306/pexels-photo-1089306.jpeg?auto=compress&cs=tinysrgb&w=1200',
    ...
    },
    {
      ...
      category: 'film',
      type: 'Documentary',
      image: 'https://images.pexels.com/photos/1054713/pexels-photo-1054713.jpeg?auto=compress&cs=tinysrgb&w=1200',
  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-12 px-6 lg:px-12 bg-earth-cream sticky top-20 z-40 border-b border-earth-beige">
        <div className="max-w-7xl mx-auto">
          <FadeIn>
      ...
      {/* <section className="py-24 px-6 lg:px-12 bg-earth-beige">
        <FadeIn>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-earth-stone text-lg mb-12 leading-relaxed">
              We'd love to hear about your vision and explore how we can bring it to life
            </p>
            <a
              href="#contact"
              className="inline-block bg-earth-charcoal text-earth-cream px-10 py-4 hover:bg-earth-brown transition-colors duration-300 tracking-wider"
            >
              Let's Talk
            </a>
          </div>
